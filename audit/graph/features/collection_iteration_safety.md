...
tags: [status/seeded, risk/medium, category/collection]
---

# Collection Iteration Safety

> **Category:** [[categories/collection|Collection wrappers + element helpers]]  ·  **Status:** `seeded`  ·  **Risk:** `medium`  ·  **Specialist:** `.claude/agents/collection_iteration_safety-specialist.md`
